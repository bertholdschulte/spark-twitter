...
public class PolarityBasic {
	...
	public void train(String message, String category) {
		Classification classification = new Classification(category);
		Classified<CharSequence> classified = new Classified<CharSequence>(message, classification);
	 ...
	 * PolarityBasic(args).run(); } catch (Throwable t) { System.out.println(
